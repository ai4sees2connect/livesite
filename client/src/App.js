...
function App() {
  ...
  return (
    <>
      {(location.pathname === "/" || (location.pathname.startsWith("/internships") && !location.pathname.startsWith("/student")) )  &&  (
        <NavbarUniversal />
      )}
      {!location.pathname.endsWith("/signup") &&
        !location.pathname.endsWith("/forget-pass") &&
      ...
      {!location.pathname.endsWith("/signup") &&
        ...
        !location.pathname.endsWith("/login") &&
        location.pathname !== "/" &&
        location.pathname.startsWith("/recruiter") && <RecNavbar />}
      <Routes>


      <Route path="/" element={<HomeUniversal />} />
      <Route path="/internships/:type?" element={<InternshipsUniversal />} />
        ...
        <Route path="/student/internships/:userId/:type?" element={<Internships />} />
        <Route
          path="/student/myApplications/:userId"
        ...
        <Route
          path="/recruiter/:recruiterId/chatroom"
          element={<RecChatRoom />}
        />
        <Route
          path="/recruiter/:internshipId/application-details/:studentId"
          element={<ApplicationDetails />}
        />
        <Route
          path="/recruiter/:recruiterId/pricing"
          element={<RecPricing />}
        />
        ...
        <Route
          path="/recruiter/forget-pass"
          element={<ForgetPasswordRecruiter />}
        />
        <Route
          path="/student/forget-pass"
