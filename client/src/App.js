...
function App() {
  ...
  // Condition to hide navbar on Auth and Admin pages
  const hideNavbar = 
  ...
  return (
    <>
      {/* Render the single unified navbar */}
      ...
      <Routes>
        ...
        <Route path="/recruiter/dashboard/:recruiterId/applicants/:internshipId/:pageNum?" element={<Applicants />} />
