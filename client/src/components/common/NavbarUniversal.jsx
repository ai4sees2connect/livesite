  ...
  return (
    <nav className="bg-white fixed top-0 w-full shadow-md z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between sm:justify-start items-center h-20">
        ...
        {/* Navigation Links */}
        <div
          className="hidden sm:flex items-center justify-between  text-sm
        ...
        >
          ...
          <div className="hidden sm:flex relative group  items-center justify-center space-x-2 ">
            ...
            <Link to="/student/signup">
              <button className="text-sm md:text-base bg-blue-400 text-white rounded-md font-semibold px-1 md:px-2 py-1 ">
                Sign-up
              </button>
            </Link>
      ...
      <div
        className={`sm:hidden fixed top-0 left-0 w-[50%] h-screen bg-gray-100 shadow-xl z-20 border
