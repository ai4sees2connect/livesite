            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _summaryChip('Total', '${applications.length}', primary),
                      const SizedBox(width: 8),
                      _summaryChip('Active', '3', const Color(0xFF10B981)),
                      const SizedBox(width: 8),
                      _summaryChip('Rejected', '1', const Color(0xFFEF4444)),
                    ],
                  ),
                ],
              ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final statusColor = Color(app['statusColor'] as int);
                  return Container(
