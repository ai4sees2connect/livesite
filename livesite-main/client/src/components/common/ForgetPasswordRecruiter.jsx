...
const ForgetPasswordRecruiter = () => {
  ...
  const handleVerifyOtp = async (e) => {
    try {
      ...
      const response = await axios.post(
        `${api}/recruiter/forget-pass/verify-otp`,
        {
          email: email,
          otp: otp,
        }
  ...
  const handleSendOtp = async (e) => {
    try {
      ...
      setSendingOtp(true);
      const response = await axios.post(
        `${api}/recruiter/forget-pass/send-otp`,
        { email }
      );
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      const response = await axios.put(`${api}/recruiter/update-password`, {
  ...
  return (
    <div className="flex flex-col items-center mt-40 space-y-5 h-screen px-4">
      ...
      <div className="flex flex-col items-center w-full lg:w-[60%] border-2 rounded-md">
        <div className="flex flex-col w-full max-w-lg p-5">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className={`${
                    !isFormValid
                      ? "bg-gray-400 "
                      : "bg-gradient-to-r from-blue-500 to-blue-800 hover:from-blue-800 hover:to-blue-600"
...
export default ForgetPasswordRecruiter;
